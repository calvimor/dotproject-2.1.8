<?php /* FORUMS $Id: post_message.php 6199 2013-01-15 06:12:03Z ajdonnison $ */
...
<textarea name="message_parent_body" cols="60" readonly="readonly" style="height:100px; font-size:8pt">
<?php

//echo $AppUI->___($message_info['message_body']);
echo dPformSafe($message_info['message_body']);
//echo $message_info['message_body'];
    ...
    <td align="left" valign="top">
       ...
       /*
            if ( message_id == 0 and ( $message_parent != -1 ) ){
                echo '\n' . dPformSafe( $last_message_info['message_info'] ) .
                     '\n' . dPformSafe( $message_info['message_body' );
            }
       */
       //echo $AppUI->___((($message_id == 0) and ($message_parent != -1)) ? "\n>"  .  $last_message_info['message_body'] . "\n" : $message_info['message_body'] );
       //echo dPformSafe((($message_id == 0) and ($message_parent != -1)) ? "\n>"  .  $last_message_info['message_body'] . "\n" : $message_info['message_body'] );
