...
$config_options = array(
  ...
  "default_watcher" => array(
	...
	"default_notify_by_email" => array(
		"description" => $AppUI->_('Email Notification as Default'),
		"value" => 1,
		'type' => 'radio',
		'buttons' => array (1 => $AppUI->_('Yes'),
                		    0 => $AppUI->_('No'))
	...
	"notity_email_address" => array(
                "description" => $AppUI->_('Email address that sends acknowledgement emails)'),
