...
require DP_BASE_DIR . '/includes/cleanup_functions.php';
require DP_BASE_DIR . '/classes/Date.class.php';
require DP_BASE_DIR . '/classes/PDFRenderer.class.php';

require DP_BASE_DIR . '/classes/GanttRenderer.class.php';
...
$showWork = (int) dPgetParam($_REQUEST, 'showWork', 0);

$showPinned = (int) dPgetParam( $_REQUEST, 'showPinned', false );
$showArcProjs = (int) dPgetParam( $_REQUEST, 'showArcProjs', false );
$showHoldProjs = (int) dPgetParam( $_REQUEST, 'showHoldProjs', false );
$showDynTasks = (int) dPgetParam( $_REQUEST, 'showDynTasks', false );
$showLowTasks = (int) dPgetParam( $_REQUEST, 'showLowTasks', true);
...
*/
$caller = dPgetParam($_REQUEST, 'caller', null);
...
$width = 1600;
$gantt_start_date = dPgetParam($_GET, 'start_date', $start_min);
$gantt_end_date = dPgetParam($_GET, 'end_date', $end_max);
...
foreach ($gtask_sliced as $gts) {
    ...
    $filename = DP_BASE_DIR."/files/temp/GanttPNG_".md5(time())."_$page.png";
