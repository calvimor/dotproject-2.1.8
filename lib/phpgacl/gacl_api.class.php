...
class gacl_api extends gacl {
    ...
    function get_object_id($section_value, $value, $object_type=NULL) {
        ...
        //Return the ID.
        /* The original code returned $row[0] but stopped working for some reason. It turned out that
         * $row['id'] was the only available choice from the $row array
         */

        /* Accept the original code only if the element is there otherwise return the alternative that was found to work */
